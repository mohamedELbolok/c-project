...
{    
    ...
    public class DGVPrinter
    {
        ...
        public DGVPrinter()
        {
            ...
            // set default fonts
            pagenofont = new Font("Tahoma", 20, FontStyle.Regular, GraphicsUnit.Point);
            pagenocolor = Color.Black;
            titlefont = new Font("Tahoma", 24, FontStyle.Bold, GraphicsUnit.Point);
            titlecolor = Color.Black;
            subtitlefont = new Font("Tahoma", 20, FontStyle.Bold, GraphicsUnit.Point);
            subtitlecolor = Color.Black;
            footerfont = new Font("Tahoma", 18, FontStyle.Bold, GraphicsUnit.Point);
